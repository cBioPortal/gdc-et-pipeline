...
public class Aliquots {
    ...
    protected List<Aliquot> aliquot;
     ...
     * This is why there is not a <CODE>set</CODE> method for the aliquot property.
     * 
     * <p>
     ...
     * 
     */
    public List<Aliquot> getAliquot() {
        if (aliquot == null) {
            aliquot = new ArrayList<Aliquot>();
        }
        return this.aliquot;
    }
