...
@XmlRootElement(name = "additional_studies")
public class AdditionalStudies {

    @XmlElement(name = "additional_study")
    protected List<AdditionalStudy> additionalStudy;
     ...
     * This is why there is not a <CODE>set</CODE> method for the additionalStudy property.
     * 
     * <p>
     ...
     * 
     */
    public List<AdditionalStudy> getAdditionalStudy() {
        if (additionalStudy == null) {
            additionalStudy = new ArrayList<AdditionalStudy>();
        }
