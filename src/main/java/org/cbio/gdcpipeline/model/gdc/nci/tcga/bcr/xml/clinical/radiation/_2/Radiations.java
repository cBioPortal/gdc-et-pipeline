...
@XmlRootElement(name = "radiations")
public class Radiations {

    protected List<Radiation> radiation;
     ...
     * This is why there is not a <CODE>set</CODE> method for the radiation property.
     * 
     * <p>
     ...
     * 
     */
    public List<Radiation> getRadiation() {
        if (radiation == null) {
            radiation = new ArrayList<Radiation>();
        }
