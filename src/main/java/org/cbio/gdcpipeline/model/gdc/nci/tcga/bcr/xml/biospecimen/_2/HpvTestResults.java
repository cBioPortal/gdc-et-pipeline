...
public class HpvTestResults {
    ...
    protected List<HpvTestResult> hpvTestResult;
     ...
     * This is why there is not a <CODE>set</CODE> method for the hpvTestResult property.
     * 
     * <p>
     ...
     * 
     */
    public List<HpvTestResult> getHpvTestResult() {
        if (hpvTestResult == null) {
            hpvTestResult = new ArrayList<HpvTestResult>();
        }
